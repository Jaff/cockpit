...
.controller('BarCtrl', ['$rootScope', '$scope', function ($rootScope, $scope)
    {
        ...
        $scope.options = {
            ...
            barStrokeWidth: 1,
            /* Thickness of bar outline */
            barValueSpacing: 3,
            /* Spacing between each set of data */
            barDatasetSpacing: 3,
            /* Spacing between each series bars */
            animationSteps: 120,
            /* How smooth should the animation be in */
            tooltipFillColor: "#2c9c69",
            /* Changes the tooltip BG colour */
            scaleFontSize: 12,
            /* Font size (used across whole chart) */
            tooltipFontSize: 12,
        ...
        $scope.colours = ['#F00000', '#008000'] /* Changes both outline oand fill of Series */
...
.controller('RadarCtrl', ['$scope', function ($scope)

    {
        ...
        $scope.options = {
            ...
            /* Set the easing animation (http://easings.net) */
        };
        ...
        $scope.data = [[30, 20, 30, 20, 30, 20, 30, 20, 30, 20, 30, 20, 30, 20],
                       [40, 15, 15, 40, 15, 15, 15, 40, 15, 15, 15, 40, 15, 15]];
        $scope.colours = ['#FFA500', '#008000'] /* Changes both outline oand fill of Series */
...
.controller('PieCtrl', ['$scope', function ($scope)

    {
        ...
        $scope.colours = ['#BDB76B', '#ADFF2F', '#FF0000'] /* Changes both outline oand fill of Series */
